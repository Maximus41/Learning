package `in`.agn.studytracker.subjects.uicontrollers
...
import `in`.agn.studytracker.subjects.adapters.SubjectDetailsAdapter
import `in`.agn.studytracker.subjects.models.SubjectPageModel
import `in`.agn.studytracker.subjects.models.SubjectSectionModel
