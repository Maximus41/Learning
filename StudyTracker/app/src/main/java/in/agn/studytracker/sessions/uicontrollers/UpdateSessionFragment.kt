package `in`.agn.studytracker.sessions.uicontrollers
...
import com.agn.corea.models.subjects.PageCumulativeProgress_
import com.agn.corea.models.subjects.Page_
...
import `in`.agn.studytracker.common.adapter.VerticalSpacingItemDecoration
import `in`.agn.studytracker.common.objectbox.ObjectBox
import `in`.agn.studytracker.common.uicontrollers.MainActivity
import com.agn.studytracker.databinding.FragmentUpdateSessionBinding
import `in`.agn.studytracker.sessions.adapters.UpdateSessionAdapter
import `in`.agn.studytracker.sessions.models.UpdateTopicPageModel
import `in`.agn.studytracker.sessions.models.UpdateTopicSectionModel
...
class UpdateSessionFragment : Fragment(), OnItemClickListener {
    ...
    private fun loadPageProgress(pageIds : List<String>) {
        val disposable = RxQuery.single(
            ObjectBox.store.boxFor(PageCumulativeProgress::class.java)
